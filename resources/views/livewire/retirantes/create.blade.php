...
<section class="w-full">
    ...
    <div class="flex items-center justify-between mb-5">
        <div>
            <h1 class="text-2xl font-bold">Cadastro de retirantes</h1>
            <p class="">Informe os dados abaixo e cadastre um novo retirante</p>
        </div>
        <a href="{{ route('retirantes.index') }}"
    ...
    <div>
        <div class="p-6 text-gray-900 dark:text-gray-100">
            <livewire:retirantes.form :dados="$formData" @dados-updated="$set('formData', $event)" />
        </div>
    </div>
</section>
