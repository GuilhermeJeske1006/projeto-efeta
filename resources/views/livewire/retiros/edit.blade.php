...
$carregarDadosRetiro = function () {
    try {
        $this->retiro = Retiro::findOrFail($this->retiroId);

        // Carregar dados básicos da retiro
        $this->formData = [
            'nome' => $this->retiro->nome,
            'descricao' => $this->retiro->descricao,
            'tema' => $this->retiro->tema,
            'data_inicio' => $this->retiro->data_inicio,
            'data_fim' => $this->retiro->data_fim,
            'musica_tema' => $this->retiro->musica_tema,
        ];
...
$salvar = function () {
    ...
    try {
        ...
        $retiro = Retiro::find($this->retiroId);
        // Save person
        $retiro->update([
            'nome' => $dados['nome'],
...
<section class="w-full">
    ...
    <div class="flex items-center justify-between mb-5">
        <div>
            <h1 class="text-2xl font-bold">Edicão de retiro</h1>
            <p class="">Informe os dados abaixo e edite o seguinte retiro</p>
        </div>
